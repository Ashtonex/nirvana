...
<div style="font-family:Calibri,Arial,sans-serif;max-width:960px;margin:0 auto;background:#0f172a;color:#f1f5f9;">
  ...
  <div style="padding:28px 32px;border-bottom:3px solid #10b981;">
    ...
    <div style="display:grid;grid-template-columns:repeat(6,1fr);gap:10px;margin-bottom:16px;">
      ...
      <div style="background:#1e293b;padding:14px 10px;border-radius:8px;text-align:center;">
        ...
        <p style="margin:6px 0 0;font-size:18px;font-weight:900;color:#fff;">$${kipasaTodaySales.reduce((s,n,x) => s+Number(x?.total_with_tax||0), 0).toFixed(2)}</p>
  ...
  <div style="padding:28px 32px;border-bottom:3px solid #3b82f6;">
    ...
    <div style="display:grid;grid-template-columns:repeat(6,1fr);gap:10px;margin-bottom:16px;">
      ...
      <div style="background:#1e293b;padding:14px 10px;border-radius:8px;text-align:center;">
        <p style="margin:0;font-size:9px;color:#94a3b8;letter-spacing:1px;">TODAY SALES</p>
        <p style="margin:6px 0 0;font-size:18px;font-weight:900;color:#fff;">$${otherTodaySales.reduce((s,n,x) => s+Number(x?.total_with_tax||0), 0).toFixed(2)}</p>
...
export async function POST(req: Request) {
  ...
  // Send comprehensive 4-section weekly report on EVERY power off
  // Shows: EOD + Kipasa weekly + Dub Dub/TC weekly + Entire Business weekly (Ops + Invest)
