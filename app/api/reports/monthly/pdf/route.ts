...
export async function GET(req: Request) {
  try {
    ...
    drawText(`Monthly Performance Report | ${winAnsiSafe(data.shopName).toUpperCase()}`, 12, true, COLORS.neutral);
    ...
    // --- WEEKLY TRENDS ---
    ensureSpace(200);
    drawText("2. WEEKLY PERFORMANCE BREAKDOWN", 12, true, COLORS.primary);
    y -= 10;
