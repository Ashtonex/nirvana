...
export default function POS({ shopId, inventory, db }: { shopId: string, inventory: any[], db: any }) {
    ...
    const CASH_OUT_CATEGORIES = new Set(["POS Expense", "Operations Transfer", "Perfume", "Overhead", "Tithe", "Groceries", "Savings", "Blackbox", "Transfer"]);
    ...
    const todaysPosExpenses = ledger.filter((l: any) =>
        (['POS Expense', 'Perfume', 'Overhead', 'Tithe', 'Groceries', 'Operations Transfer', 'Savings', 'Blackbox', 'Transfer'].includes(l.category) || isSavingsOrBlackboxTransferEntry(l)) &&
        l.shopId === shopId &&
        String(l.date).startsWith(todayStr)
